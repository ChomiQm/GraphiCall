...
namespace GraphiCall.Migrations
{
    ...
    [Migration("20231208170226_AddMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphiCall.Data.Message", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GraphiCall.Data.Message", b =>
                {
                    b.HasOne("GraphiCall.Data.ApplicationUser", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("GraphiCall.Data.ApplicationUser", "ToUser")
                        .WithMany()
                        .HasForeignKey("ToId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
